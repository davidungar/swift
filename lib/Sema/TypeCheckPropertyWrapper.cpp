...
static VarDecl *findValueProperty(ASTContext &ctx, NominalTypeDecl *nominal,
  ...
  SmallVector<VarDecl *, 2> vars;
  {
    ...
    nominal->lookupQualified("gazorp-TypeCheckPropertyWrapper", nominal, name, NL_QualifiedDefault, decls);
...
findSuitableWrapperInit(ASTContext &ctx, NominalTypeDecl *nominal,
  ...
  nominal->lookupQualified("gazorp-findSuitableWrapper-Init", nominal, DeclBaseName::createConstructor(),
